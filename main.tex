...
\scriptsize
\noindent\textbf{Selected references:} Dotlačil, J. (2011). Fastidious distributivity. In \textit{SaLT} (Vol. 21, pp. 313-332) $\bullet$ Dotlačil, J. (2012). Binominal each as an anaphoric determiner. In \textit{SuB} (Vol. 16, pp. 211-224) 
